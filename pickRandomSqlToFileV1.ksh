...
# Description START
#
# The script prints results to a text file
...
# Set umask if output is going into a file
umask 077
...
outputFile="fetch.txt"
outputFPath="${scriptRoot}/${outputFile}"
...
sqlite3 "$inputFPath" "$optString" "$sqlString" |
  >| "$outputFPath" tr '\n' ' ' &&
    ...
    >> "$outputFPath" print -- '' &&
      print -u2 -- "\nFile ${tRed}${outputFPath}${tNorm} was created!\n"
